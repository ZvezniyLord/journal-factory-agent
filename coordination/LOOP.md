...
У проєкті активно працюють **лише два агенти**:

1. **Codex** — пише код, запускає тести, збирає DOCX/PDF, комітить і пушить результати.
2. **Reviewer (цей чат)** — перевіряє код та артефакти, формує наступну інструкцію, приймає або повертає ітерацію.

Інші гілки та Issues є резервними й не запускаються без окремої команди користувача.
